...
public class RetrofitServiceClientImgur {
    ...
    private static final String BASE_URL = "";  // TODO: 05/07/2018 put backend's base url here when exists
    ...
    public static SappaApi getSappaApi() {
        Retrofit retrofit = RetrofitServiceClientImgur.getRetrofit();
        return retrofit.create(SappaApi.class);
    }
